...
int HuffmanNode::s_createdCount = 0;
int HuffmanNode::s_deletedCount = 0;
...
int HuffmanNode::getCreatedCount() {
    return s_createdCount;
}

int HuffmanNode::getDeletedCount() {
    return s_deletedCount;
}

int HuffmanNode::getNodesStillCreatedCount() {
    return getCreatedCount() - getDeletedCount();
}

bool HuffmanNode::hasNodesStillCreated() {
    return getNodesStillCreatedCount() > 0;
}

void HuffmanNode::resetCreatedDeletedCounts() {
